...
export const metadata: Metadata = {
  title: "Gheorghe Gherciu",
  description:
    "Welcome to Gheorghe Gherciu's portfolio! Learn more about me and my projects.",
};
      ...
      <div className="square-background mt-20 flex shrink-0 items-center justify-center md:mt-0 md:h-[70vh]">
        <div className="container grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="mt-10 w-full md:mt-0">
            ...
            <p className="text-xl">
              my name is Gheorghe. I love technology and always want to be up to date with the
              latest advancements.
              <br /> <br /> At the moment I'm working on my open-source projects.
            </p>
            <div className="mt-7 flex space-x-8">
              <IconButton target="_blank" href="https://github.com/gherciu">
                <FaGithub size={20} />
              </IconButton>
              <IconButton
                target="_blank"
                href="https://www.linkedin.com/in/gherciu/"
              >
                <FaLinkedin size={20} />
              </IconButton>
              <IconButton
                target="_blank"
                href="mailto:gherciu553@gmail.com"
              >
                <HiMail size={20} />
              </IconButton>
            </div>
